...
const Portfolio = React.forwardRef(({ animateArr }, ref) => {
  ...
  const exps = [
    ...
    },
    {
      ...
      pointers: [
        "Created using React with React Hooks and Stateless Functional Components",
        "One-page scrolling experience created using Intersection Observer API.",
        "Handwritten CSS with custom animations, flexbox and grid",
      ],
      logos: [
        { name: "HTML", logo: html },
        { name: "CSS", logo: css },
    ...
    },
    {
      ...
      logos: [
        ...
        { name: "Telegram Bot", logo: telegram },
      ],
    },
  ];
